...
let deviceId;
function useDeviceId(global2 = qa) {
...
function populateParameters(fromRes, toRes) {
  ...
  const parameters = {
    ...
    uniPlatform: "quickapp-webview-union",
    deviceBrand,
    deviceModel: model,
    deviceType,
...
qa.createSubpackageApp = global.createSubpackageApp = createSubpackageApp;
